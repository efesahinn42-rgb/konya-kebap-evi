...
export default function MenuSidebar() {
    ...
    return (
        <div className="flex flex-col w-full py-6 sm:py-8 lg:py-0 bg-black">
            <Link href="/" className="mb-8 sm:mb-10 lg:mb-12">
                ...
                {menuItems.map((item) => {
                    ...
                    if (item.isPage) {
                        return (
                            ...
                            >
                                <motion.span
                                    className={`block text-xs sm:text-sm lg:text-base font-bold tracking-[0.2em] sm:tracking-[0.25em] text-left py-2 sm:py-2.5 lg:py-3 transition-colors cursor-pointer ${
