...
const fallbackPressItems = [
    {
        ...
        image_url: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=600",
        color: "#dc2626"
    },
    {
        ...
        image_url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=600",
        color: "#2563eb"
    },
    {
        outlet: "CNN Türk",
        ...
        image_url: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=600",
        color: "#dc2626"
    },
    {
        outlet: "Radyo Konya",
                ...
                <div className="min-h-screen flex items-center justify-center py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12">
                    <div className="relative max-w-[1400px] w-full">
                        <div className="text-center mb-12">
                            <div className="h-8 w-48 bg-zinc-800 rounded mx-auto mb-4 animate-pulse" />
                            <div className="h-12 w-64 bg-zinc-800 rounded mx-auto animate-pulse" />
                        </div>
                        <div className="h-[400px] bg-zinc-800 rounded-2xl animate-pulse mb-6" />
                        <div className="grid grid-cols-3 gap-6">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="h-[250px] bg-zinc-800 rounded-xl animate-pulse" />
                            ))}
                        </div>
                    </div>
                </div>
                        ...
                        <>
                            ...
                            >
                                <div className="relative h-[300px] sm:h-[400px] lg:h-[500px]">
                                    ...
                                    {/* Hover Arrow */}
                                    {pressItems[0].external_url && (
                                        <a
                                            href={pressItems[0].external_url}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="absolute top-6 right-6 sm:top-8 sm:right-8 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:bg-[#d4af37]"
                                        >
                        ...
                        <div className="flex items-center gap-8 text-zinc-600 animate-marquee whitespace-nowrap">
                            {[...Array(3)].map((_, i) => (
                                <div key={i} className="flex items-center gap-8">
                                    ...
                                    <span className="text-[#d4af37]">★</span>
                                    <span className="text-sm font-bold tracking-wider">TÜRKİYE GASTRONOMİ DERNEĞİ</span>
                                    <span className="text-[#d4af37]">★</span>
